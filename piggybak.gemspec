...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "db/migrate/20121008160425_rename_variants_to_sellables.rb",
    "db/migrate/20121008175144_line_item_rearchitecture.rb",
